...
## Run an example
The results of the Table 2 in row 1 with one abstraction level of the paper `SMC4PEP: A Conversion Tool for an Automated Verification of Product Engineering Processes` can be reproduced based on the file located in `SMC4PEP_v1.1/examples/UC from Journal/Row 3 of Table 2 Abstr. level 3`.
...
5. Upload the file  `UC_Abstr_level_3.xml` located in  `SMC4PEP_v1.1/examples/UC from Journal/Row 3 of Table2 Abstr. level 3/Process Model (eBPMN Design)` by using the button `Choose File` of SMC4PEP
...
9. Now properties of interests can be verified (see section Reproducing the results of the paper)
    ...
    -> Result: 1 inital state, 9226 states, 34629 transitions are obtained
    ...
    5. Verifying property phi_3 of the table
     ...
     6. Verifying property phi_4 of the table
        ...
        -> select Okay
        -> 380.0282033873277 (+/- 1.0 with probability 0.999; rel err 0.0026313836475467907) ---> expected reward 
